...
## Project Structure
    ...
    ├── testapiautotasksnew_89520  # Django project configurations
...
1. Clone this repo and `cd testapiautotasksnew_89520`
...
2. Clone this repo and `cd testapiautotasksnew_89520`
